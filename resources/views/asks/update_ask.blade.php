      ...
      <!--breadcrumb-->
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
              <div class="card">
                 <div class="card-body">
                    <form action="{{ route('store_update_ask') }}" method="POST">
                        @csrf
                          <div class="mb-4">
                      <h5 class="mb-3">الاسم</h5>
                      <input type="text" value="{{ $ask->title }}" name="title" class="form-control" >
                      {{--  @error('title')
                  ...
                  @enderror  --}}
                      ...
                      <input type="hidden" value="{{ $ask->id }}" name="id" class="form-control" placeholder="write title here....">

                      <textarea  value="{{ $ask->description }}" name="description" class="form-control" placeholder="write title here....">{{ $ask->description }}</textarea>
                      {{--  @error('description')
