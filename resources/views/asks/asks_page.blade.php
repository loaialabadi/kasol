...
@endif
    ...
    <div class="main-content">
        ...
        <div class="ps-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">الاسئله الشائعه</li>
            </ol>
          </nav>
        </div>
        <div class="ms-auto">
      ...
      {{--    <div class="col-auto">
          <div class="position-relative">
            <input class="form-control px-5" type="search" placeholder="Search asks">
            <span
        ...
        <div class="col-auto">
          <div style="justify-content: space-between" class="d-flex align-items-center gap-2 justify-content-lg-end justify-between">
            ...
            <a class="btn btn-primary px-4" href="/asks/add_new_ask">
                <i class="bi bi-plus-lg me-2"></i>إضافه
            </a>
            {{--  <button class="btn btn-primary px-4"><i class="bi bi-plus-lg me-2"></i>Add ask</button>  --}}
          </div>
        </div>
      </div><!--end row-->
              ...
              <table class="table align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ \Illuminate\Support\Str::limit($ask->description, 50) }}</td>
                      <td>
                        <button class="btn btn-info btn-sm" onclick="openDetailsModal('{{ $ask->title }}', '{{ $ask->description }}')">
                            عرض التفاصيل
                        </button>
                    </td>
                      <td>
                        ...
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="javascript:void(0);" onclick="openDeleteModal({{ $ask->id }})">حذف</a>
                            </li>
                            {{--  <li><a class="dropdown-item" href="{{ route('delete_ask',$ask->id) }}">Delete</a></li>  --}}
                            <li><a class="dropdown-item" href="{{ route('update_ask', $ask->id) }}">تحديث</a></li>
                            {{--  <li><a class="dropdown-item" href="{{ route('asks_pemissions', $ask->id) }}">ask Permissions</a></li>  --}}
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCart">
    ...
    <div class="offcanvas-footer h-70 p-3 border-top">
      <div class="d-grid">
        <button type="button" class="btn btn-grd btn-grd-primary" data-bs-dismiss="offcanvas">View asks</button>
      </div>
    </div>
  </div>
  <!--end cart-->
  ...
  <div class="modal fade" id="detailsModal" tabindex="-1" aria-labelledby="detailsModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><strong>العنوان:</strong> <span id="modalAskTitle"></span></p>
                <p><strong>الوصف:</strong></p>
                <p id="modalAskDescription"></p>
            </div>
            <div class="modal-footer">
...
<script>
    ...
    $('#confirmDeleteButton').on('click', function () {
        if (categoryIdToDelete) {
            ...
            window.location.href = "{{ route('delete_ask', '') }}" + '/' + categoryIdToDelete;
        }
    });
...
<script>
    function openDetailsModal(title, description) {
        document.getElementById('modalAskTitle').innerText = title;
        document.getElementById('modalAskDescription').innerText = description;
