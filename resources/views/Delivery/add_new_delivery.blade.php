...
@endif
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">إضافة مندوب جديد</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('store_new_deli') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="tel" name="phone" class="form-control" placeholder="أدخل رقم الهاتف..." required />
                        </div>
