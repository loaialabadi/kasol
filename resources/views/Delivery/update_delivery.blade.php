...
<div class="main-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">المكونات</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">تحديث بيانات المندوب</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12 col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('store_update_delivery') }}" method="POST">
                        @csrf
                        <input type="hidden" name="id" value="{{ $delivery->id }}" />

                        <div class="mb-4">
                            <h5 class="mb-3">الاسم</h5>
                            <input type="text" name="name" class="form-control" value="{{ $delivery->name }}" placeholder="أدخل الاسم..." required />
                        </div>

                        <div class="mb-4">
                            <h5 class="mb-3">البريد الإلكتروني</h5>
                            <input type="email" name="email" class="form-control" value="{{ $delivery->email }}" placeholder="أدخل البريد الإلكتروني..." required />
                        </div>

                        <div class="mb-4">
                            <h5 class="mb-3">رقم الهاتف</h5>
                            <input type="tel" name="phone" class="form-control" value="{{ $delivery->phone }}" placeholder="أدخل رقم الهاتف..." required />
                        </div>

                        <div class="mb-4">
                            <h5 class="mb-3">كلمة المرور</h5>
                            <input type="password" name="password" class="form-control" placeholder="أدخل كلمة المرور (اختياري)" />
                        </div>
...
<script>
    ...
    @foreach ([ 'nameError', 'description'] as $field)
        @if ($errors->has($field))
