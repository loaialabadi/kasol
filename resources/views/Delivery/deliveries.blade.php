    ...
    <div class="main-content">
        ...
        <div class="ps-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">عمال التوصيل</li>
            </ol>
          </nav>
        </div>
        <div class="ms-auto">
      ...
      {{--    <div class="col-auto">
          <div class="position-relative">
            <input class="form-control px-5" type="search" placeholder="Search deliveries">
            <span
        ...
        <div class="col-auto">
          <div style="justify-content: space-between" class="d-flex align-items-center gap-2 justify-content-lg-end justify-between">
            ...
            <a class="btn btn-primary px-4" href="/deliveries/add_new_delivery">
                <i class="bi bi-plus-lg me-2"></i>ضافة طلب توصيل
            </a>
            {{-- <button class="btn btn-primary px-4">
    <i class="bi bi-plus-lg me-2"></i>إضافة طلب توصيل
</button> --}}
...
<tr>
    ...
    <td>
        @if ($delivery->ban == "active")
            <img src="" alt="غير محظور"/>
        @else
            <img src="" alt="محظور"/>
        @endif
    </td>
    <td>
        <a class="btn btn-primary" href="{{ route('change_del_status', ['id' => $delivery->id]) }}">
            تحديث الحالة
        </a>
    </td>
    <td>
            ...
            <ul class="dropdown-menu">
                <li>
                    <a class="dropdown-item" href="javascript:void(0);"
                       onclick="openDeleteModal({{ $delivery->id }})">حذف</a>
                </li>
                {{--  <li><a class="dropdown-item" href="{{ route('delete_delivery', $delivery->id) }}">حذف</a></li>  --}}
                <li>
                    <a class="dropdown-item" href="{{ route('update_delivery', $delivery->id) }}">
                        تحديث
                    </a>
                </li>
                {{--  <li><a class="dropdown-item" href="{{ route('deliveries_pemissions', $delivery->id) }}">أذونات المندوب</a></li>  --}}
            </ul>
        </div>
    </td>
</tr>
@endforeach
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCart">
    ...
    <div class="offcanvas-footer h-70 p-3 border-top">
      <div class="d-grid">
        <button type="button" class="btn btn-grd btn-grd-primary" data-bs-dismiss="offcanvas">View deliveries</button>
      </div>
    </div>
  </div>
  <!--end cart-->
...
<script>
    ...
    $('#confirmDeleteButton').on('click', function () {
        if (categoryIdToDelete) {
            ...
            window.location.href = "{{ route('delete_delivery', '') }}" + '/' + categoryIdToDelete;
        }
    });
