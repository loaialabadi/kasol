           ...
           <div class="col-12 col-md-8 col-lg-6 col-xl-5 col-xxl-4 mx-auto">
            <div class="card rounded-4 mb-0 border-top border-4 border-primary border-gradient-1">
              <div class="card-body p-5">
                  ...
                  <h4 class="fw-bold">سجل دخول</h4>
                  <p class="mb-0">أدخل حسابك من هنا</p>

                  <div class="form-body my-5">
										<form method="POST" action="{{ route('login_action') }}" class="row g-3">
                                            @csrf
                                            @if ($errors->any())
    <div class="alert alert-danger">
...
@endif
                                            <div class="col-12">
												<label for="inputEmailAddress" class="form-label">البريد الالكترونى</label>
												<input name="email" type="email" class="form-control" id="inputEmailAddress" placeholder="jhon@example.com">
											</div>
											<div class="col-12">
												<label for="inputChoosePassword" class="form-label">كلمه السر</label>
                          ...
                          <a href="javascript:;" class="input-group-text bg-transparent"><i class="bi bi-eye-slash-fill"></i></a>
											...
											<div class="col-12">
												<div class="d-grid">
													<button type="submit" class="btn btn-grd-primary">تسجيل</button>
												</div>
											</div>
											<!--<div class="col-12">-->
