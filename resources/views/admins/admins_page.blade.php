...
<body>
        ...
        <div class="ps-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">الادمنز</li>
            </ol>
          </nav>
        </div>
        <div class="ms-auto">
      ...
      <div class="row g-3">
        {{--  <div class="col-auto">
          <div class="position-relative">
            <input class="form-control px-5" type="search" placeholder="Search admins">
            <span
        ...
        <div class="col-auto">
          <div class="d-flex align-items-center gap-2 justify-content-lg-end">
            ...
            <a class="btn btn-primary px-4" href="/admins/add_new_admin">
                <i class="bi bi-plus-lg me-2"></i>إضافه ادمن
            </a>
            {{--  <button class="btn btn-primary px-4"><i class="bi bi-plus-lg me-2"></i>Add admin</button>  --}}
          </div>
        </div>
      </div><!--end row-->
                ...
                <table class="table align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <!-- Admin Image -->
                            <td>
                                <img style="width:100px" src="{{ asset('storage/' . $admin->image) }}" alt="Admin Image">
                            </td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="javascript:void(0);" onclick="openDeleteModal({{ $admin->id }})">حذف</a>
                                        </li>
                                        {{--  <li><a class="dropdown-item" href="{{ route('delete_admin', $admin->id) }}" onclick="return confirm('Are you sure you want to delete this admin?')">Delete</a></li>  --}}
                                        <li><a class="dropdown-item" href="{{ route('update_admin_page', $admin->id) }}">تحديث</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCart">
    ...
    <div class="offcanvas-footer h-70 p-3 border-top">
      <div class="d-grid">
        <button type="button" class="btn btn-grd btn-grd-primary" data-bs-dismiss="offcanvas">View admins</button>
      </div>
    </div>
  </div>
  <!--end cart-->
...
<script>
    ...
    $('#confirmDeleteButton').on('click', function () {
        if (categoryIdToDelete) {
            ...
            window.location.href = "{{ route('delete_admin', '') }}" + '/' + categoryIdToDelete;
        }
    });
