      ...
      <!--breadcrumb-->
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
              <div class="card">
                 <div class="card-body">
                    <form method="POST" action="{{ route('store_new_admin') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            @error('email')
                                <div class="alert alert-danger" id="emailError">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @error('phone')
                                <div class="alert alert-danger" id="phoneError">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @error('address')
                                <div class="alert alert-danger" id="addressError">{{ $message }}</div>
                            @enderror
                        </div>

                        <!-- Admin Password -->
                        <div class="mb-4">
                            <h5 class="mb-3">كلمه السر</h5>
                            <input type="password" name="password" class="form-control" >
                            @error('password')
                                <div class="alert alert-danger" id="passwordError">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @error('gender')
                                <div class="alert alert-danger" id="genderError">{{ $message }}</div>
                            @enderror
                        </div>
