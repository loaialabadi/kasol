      ...
      <!--breadcrumb-->
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
              <div class="card">
                 <div class="card-body">
                    <form action="{{ route('store_update_gift') }}" method="POST">
                        @csrf
                          <div class="mb-4">
                      <h5 class="mb-3">Discount Value</h5>
                      <input type="number" value="{{ $gift->discount }}" name="discount" class="form-control" placeholder="write  here....">
                      <input type="hidden" value="{{ $gift->id }}" name="id" class="form-control" placeholder="write  here....">
                      {{--  @error('title')
                      <div class="alert alert-danger" id="nameError">{{ $message }}</div>
                  @enderror  --}}
                    </div>
                          <div class="mb-4">
                      <h5 class="mb-3">Discount Type</h5>
                      <select vale="{{ $gift->type }}" class="form-control" name="type" id="">
                        <option value="percentage" {{ $gift->type == 'percentage' ? 'selected' : '' }}>Percentage</option>
                        <option value="flat" {{ $gift->type == 'flat' ? 'selected' : '' }}>Flat</option>
                    </select>
