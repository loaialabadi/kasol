...
@endif
      ...
      <div style="justify-content: space-between;" class="row g-3">
        {{--  <div class="col-auto">
          <div class="position-relative">
            <form action="{{ route('search_gifts') }}" method="GET" class="d-flex">
                <input class="form-control px-5" type="search" name="search" placeholder="Search gifts" value="{{ request('search') }}">
        ...
        <div class="col-auto">
          <div class="d-flex align-items-center gap-2 justify-content-lg-end">
            ...
            <a class="btn btn-primary px-4" href="/gifts/add_new_gift">
                <i class="bi bi-plus-lg me-2"></i>Add gift
            </a>
            ...
            <div class="table-responsive white-space-nowrap">
              <table class="table align-middle">
                ...
                <tbody>
                    ...
                    <td><a class="btn btn-primary" href="{{ route('change_gift_status',['id'=>$gift->id]) }}">Update Status</a></td>
                      <td>
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="javascript:void(0);" onclick="openDeleteModal({{ $gift->id }})">Delete</a>
                            </li>
                            <li><a class="dropdown-item" href="{{ route('update_gift', $gift->id) }}">Update</a></li>
                            <li><a class="dropdown-item" href="{{ route('gift_users', $gift->id) }}">User Use It</a></li>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCart">
    ...
    <div class="offcanvas-footer h-70 p-3 border-top">
      <div class="d-grid">
        <button type="button" class="btn btn-grd btn-grd-primary" data-bs-dismiss="offcanvas">View gifts</button>
      </div>
    </div>
  </div>
  <!--end cart-->
...
<script>
    ...
    // Function to open the modal and set the gift ID for deletion
    function openDeleteModal(giftId) {
        giftIdToDelete = giftId;
        // Show the modal
    ...
    $('#confirmDeleteButton').on('click', function () {
        if (giftIdToDelete) {
            // Redirect to delete route with the gift ID
            window.location.href = "{{ route('delete_gifts', '') }}" + '/' + giftIdToDelete;
        }
    });
