...
@endif
      ...
      <div style="justify-content: space-between;" class="row g-3">
        {{--  <div class="col-auto">
          <div class="position-relative">
            <form action="{{ route('search_users') }}" method="GET" class="d-flex">
                <input class="form-control px-5" type="search" name="search" placeholder="Search users" value="{{ request('search') }}">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCart">
    ...
    <div class="offcanvas-footer h-70 p-3 border-top">
      <div class="d-grid">
        <button type="button" class="btn btn-grd btn-grd-primary" data-bs-dismiss="offcanvas">View users</button>
      </div>
    </div>
  </div>
  <!--end cart-->
