      ...
      <!--breadcrumb-->
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
              <div class="card">
                 <div class="card-body">
                    <form action="{{ route('store_update_category') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                          <div class="mb-4">
                      <h5 class="mb-3">الاسم</h5>
                      <input value="{{$category->name}}" type="text" name="name" class="form-control" placeholder="write  here....">
                      <input value="{{$category->id}}" type="hidden" name="id" class="form-control" placeholder="write  here....">
                   </div>
                   <div class="my-2">
                    <img id="currentImage" src="{{ asset('storage/' . $category->image) }}" alt="الصوره الحاليه" style="width: 150px; height: 150px; object-fit: cover; border-radius: 50%;">
                </div>
                   <div class="mb-4">
                      <h5 class="mb-3">الصوره</h5>
                      <input id="imageUpload" type="file" name="image" class="form-control" placeholder="write title here....">
                   </div>
                   <div class="my-4">
