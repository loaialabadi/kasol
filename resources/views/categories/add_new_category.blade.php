      ...
      <!--breadcrumb-->
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
              <div class="card">
                 <div class="card-body">
                    <form action="{{ route('store_new_category') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                          <div class="mb-4">
                   ...
                   <div class="mb-4">
                      ...
                      <input type="file" name="image" class="form-control" placeholder="write title here....">
                   </div>
                   <div class="my-4">
