...
@endif
        ...
        <div class="ps-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">الفئات الرئيسيه</li>
            </ol>
          </nav>
        </div>
        <!--<div class="ms-auto">-->
      ...
      <div style="justify-content: space-between;" class="row g-3">
        <div class="col-auto">
          <div class="position-relative">
            <form action="{{ route('search_categories') }}" method="GET" class="d-flex">
        ...
        <div class="col-auto">
          <div class="d-flex align-items-center gap-2 justify-content-lg-end">
            ...
            <a class="btn btn-primary px-4" href="/categories/add_new_category">
              ...
              <table class="table align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <!--  <input class="form-check-input" type="checkbox">-->
                      <!--</td>-->
                      <td><img style="width:100px" src="{{ asset('storage/' . $category->image) }}" alt="الصوره"></td>
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <div class="product-info">
                                @if ($category->status == 'active')
                                    <img src="{{ asset('path/to/active-image.png') }}" alt="نشط"/>
                                @else
                                    <img src="{{ asset('path/to/not-active-image.png') }}" alt="غير نشط"/>
                                @endif
                            </div>
                        </div>
                    </td>
                    <td><a class="btn btn-primary" href="{{ route('change_category_status',['id'=>$category->id]) }}">تغير الحاله</a></td>
                      <td>
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="javascript:void(0);" onclick="openDeleteModal({{ $category->id }})">حذف</a>
                            </li>
                                                        <li><a class="dropdown-item" href="{{ route('update_category', $category->id) }}">تحديث</a></li>
                            <li><a class="dropdown-item" href="{{ route('category_subcategories', $category->id) }}">الفئات الفرعيه</a></li>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="confirmDeleteModalLabel">تأكدي الحذف</h5>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCart">
    ...
    <div class="offcanvas-footer h-70 p-3 border-top">
      <div class="d-grid">
        <button type="button" class="btn btn-grd btn-grd-primary" data-bs-dismiss="offcanvas">View Categories</button>
      </div>
    </div>
  </div>
  <!--end cart-->
...
<script>
    ...
    // Function to open the modal and set the category ID for deletion
    ...
    $('#confirmDeleteButton').on('click', function () {
        if (categoryIdToDelete) {
            // Redirect to delete route with the category ID
            window.location.href = "{{ route('delete_categories', '') }}" + '/' + categoryIdToDelete;
        }
    });
