...
@endif
        ...
        <div class="ps-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">فئات فرعيه</li>
            </ol>
          </nav>
        </div>
        <div class="ms-auto">
      ...
      <div style="justify-content: space-between" class="row g-3">
        <div class="col-auto">
          <div class="position-relative">
            <form action="{{ route('search_subcategory',['id'=>$id]) }}" method="GET" class="d-flex">
        ...
        <div class="col-auto">
          <div class="d-flex align-items-center gap-2 justify-content-lg-end">
            ...
            <a class="btn btn-primary px-4" href="{{ route('add_new_subcategory',['id'=>$id]) }}">
              ...
              <table class="table align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <!--</td>-->
                      <td>
                        <img style="width:100px" src="{{ asset('storage/' . $subcategory->image) }}" alt="الصوره"></td>
                    ...
                    <td><a class="btn btn-primary" href="{{ route('change_subcategory_status',['id'=>$subcategory->id]) }}">تغيير الحاله</a></td>
                      <td>
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="javascript:void(0);" onclick="openDeleteModal({{ $subcategory->id }})">حذف</a>
                            </li>
                                                        <li><a class="dropdown-item" href="{{ route('update_subcategory', $subcategory->id) }}">تحديث</a></li>
                            {{--  <li><a class="dropdown-item" href="{{ route('roles_pemissions', $subcategory->id) }}">Role Permissions</a></li>  --}}
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCart">
    ...
    <div class="offcanvas-footer h-70 p-3 border-top">
      <div class="d-grid">
        <button type="button" class="btn btn-grd btn-grd-primary" data-bs-dismiss="offcanvas">View subcategories</button>
      </div>
    </div>
  </div>
  <!--end cart-->
...
<script>
    ...
    $('#confirmDeleteButton').on('click', function () {
        if (categoryIdToDelete) {
            ...
            window.location.href = "{{ route('delete_subcategory', '') }}" + '/' + categoryIdToDelete;
        }
    });
