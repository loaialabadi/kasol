      ...
      <!--breadcrumb-->
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
              <div class="card">
                 <div class="card-body">
                    <form action="{{ route('store_update_subcategory',['id'=>$id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <img id="imagePreview" style="width:100px" src="{{ asset('storage/' . $subcategory->image) }}" alt="الصوره">
                        </div>

                        <div class="mb-4 mt-2">
                            <h5 class="mb-3">الصوره الجديده</h5>
                            <input type="file" name="image" class="form-control" id="imageInput" placeholder="Choose image" onchange="previewImage(event)">
                        </div>
