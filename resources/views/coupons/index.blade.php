...
@endif
      ...
      {{--    <div class="col-auto">
        ...
        <div class="col-auto">
          <div style="justify-content: space-between" class="d-flex align-items-center gap-2 justify-content-lg-end justify-between">
            ...
            <a class="btn btn-primary px-4" href="/coupons/add_new">
  ...
  <div class="d-flex align-items-center gap-3">
    <div class="product-info">
      @if($coupn->type == 'flat')
        <span>خصم بالقيمه</span>
      @else
        <span>خصم بالنسبه</span>
      @endif
    </div>
  </div>
</td>
...
<td>
    <p>
      ...
      @endif
                 ...
                 <td><a class="btn btn-primary" href="{{route('change_cop_status',['id'=>$coupn->id])}}">تغيير الحاله</a></td>
                      <td>
                        ...
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="javascript:void(0);" onclick="openDeleteModal({{ $coupn->id }})">حذف</a>
                            </li>
                            {{--  <li><a class="dropdown-item" href="{{ route('delete_coupon',$coupn->id) }}">Delete</a></li>  --}}
                            <li><a class="dropdown-item" href="{{ route('update_coupon', $coupn->id) }}">تحديث</a></li>
                            {{--  <li><a class="dropdown-item" href="{{ route('asks_pemissions', $coupn->id) }}">ask Permissions</a></li>  --}}
...
<script>
    ...
    $('#confirmDeleteButton').on('click', function () {
        if (categoryIdToDelete) {
            ...
            window.location.href = "{{ route('delete_coupon', '') }}" + '/' + categoryIdToDelete;
        }
    });
