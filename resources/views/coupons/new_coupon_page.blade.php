      ...
      <!--breadcrumb-->
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
              <div class="card">
                 <div class="card-body">
                    <form action="{{ route('store_new_coupon') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                          <div class="mb-4">
                   ...
                   <div class="mb-3">
                       ...
                       <select class="form-control" name="type">
                           <option value="flat">الخصم بالقيمه</option>
                           <option value="percentage">الخصم بالنسبه المئويه</option>
                       </select>
                   </div>
                   <div class="mb-4">
                   ...
                   <div class="mb-4">
                      ...
                      <input type="text" name="limit_use" class="form-control"/>
                   </div>
                   <div class="my-4">
