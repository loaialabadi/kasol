...
<body>
              ...
              <div class="card">
                 <div class="card-body">
                    <form action="{{ route('edit_permission') }}" method="POST">
                        @csrf
                          <div class="mb-4">
                      <h5 class="mb-3">Permission Name</h5>
                      <input value="{{ $permission->name }}" type="text" name="name" class="form-control" placeholder="write title here....">
                      @error('name')
                      <div id="error_msg" class="alert alert-danger">{{ $message }}</div>
                  @enderror
                    </div>
                   <div class="mb-4">
                      {{--  <h5 class="mb-3">Guard Name</h5>
                      <input value="{{ $permission->guard_name }}" type="text" name="guard_name" class="form-control" placeholder="write title here....">
                    </div>  --}}
                    <input value="{{ $permission->id }}" type="hidden" name="id" class="form-control" placeholder="write title here....">
                   <div class="my-4">
  ...
  <script>
    ...
    window.onload = function() {
        let successMessage = document.getElementById('error_msg');
