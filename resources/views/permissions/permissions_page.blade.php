      ...
      <div class="row g-3">
        ...
        <div class="col-auto">
          <div class="d-flex align-items-center gap-2 justify-content-lg-end">
            ...
            <a class="btn btn-primary px-4" href="/add_new_permission">
                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="javascript:void(0);" onclick="openDeleteModal({{ $permission->id }})">Delete</a>
                            </li>

                            {{--  <li><a class="dropdown-item" href="{{ route('delete_permission_main',$permission->id) }}">Delete</a></li>  --}}
<li><a class="dropdown-item" href="{{ route('update_permission', $permission->id) }}">Update</a></li>                          </ul>
                        </div>
                      </td>
                    </tr>
                 @endforeach
  ...
  <script>
    ...
    $('#confirmDeleteButton').on('click', function () {
        if (categoryIdToDelete) {
            ...
            window.location.href = "{{ route('delete_permission_main', '') }}" + '/' + categoryIdToDelete;
        }
    });
