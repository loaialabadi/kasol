              ...
              <div class="card">
                 <div class="card-body">
                    <form action="{{ route('edit_role') }}" method="POST">
                      ...
                      <input value="{{ $role->name}}" type="text" name="name" class="form-control" placeholder="write title here....">
                   </div>
                   {{--  <div class="mb-4">
                      <h5 class="mb-3">Guard Name</h5>
                      <input value="{{ $role->guard_name}}"  type="text" name="guard_name" class="form-control" placeholder="write title here....">
                    </div>  --}}
                    <input value="{{ $role->id}}"  type="hidden" name="id" class="form-control" placeholder="write title here....">
                   <div class="my-4">
