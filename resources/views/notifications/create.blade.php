      ...
      <!--breadcrumb-->
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
              <div class="card">
                 <div class="card-body">
                    <form action="{{ route('store_notification') }}" method="POST">
                        @csrf
                          <div class="mb-4">
                      ...
                      <select class="form-control"  name="type">
                          ...
                          <option value="private">مستخدم معين</option>
                          <option value="service">خدمه معينه</option>
                      </select>
                    
                    </div>
<div class="mb-4">
    <h5 class="mb-3">المستخدمين العاديين</h5>
...
<div class="mb-4">
    <h5 class="mb-3">اصحاب الخدمات</h5>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        let usersSelect = document.querySelector('select[name="user_id"]:nth-of-type(1)');
        let servicesSelect = document.querySelector('select[name="service"]:nth-of-type(1)');
        ...
        typeSelect.addEventListener("change", toggleSelectFields);
        toggleSelectFields(); // تشغيل عند تحميل الصفحة
    });
</script>
