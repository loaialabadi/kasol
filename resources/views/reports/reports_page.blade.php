    ...
    <div class="main-content">
      ...
      {{--    <div class="col-auto">
          <div class="position-relative">
            <input class="form-control px-5" type="search" placeholder="Search reports">
            <span
        ...
        <div class="col-auto">
          {{--  <div style="justify-content: space-between" class="d-flex align-items-center gap-2 justify-content-lg-end justify-between">
            <a class="btn btn-primary px-4" href="/reports/add_new_report">
  ...
  {{--  <th>الإجراء</th>  --}}
    ...
    <tr>
        ...
        <td>
            <div class="d-flex align-items-center gap-3">
                <div class="product-info">
                    {{ isset($report->service) ? $report->service->name : '' }}
                </div>
            </div>
        </td>
        <td>{{ \Illuminate\Support\Str::limit($report->text, 50) }}</td>
        <td>
            <button class="btn btn-info btn-sm"
                    onclick="openDetailsModal(
                        '{{ $report->user->name }}',
                        '{{ isset($report->user->image) ? $report->user->image : '' }}',
                        '{{ isset($report->service) ? $report->service->name : '' }}',
                        '{{ $report->text }}'
                    )">
                عرض التفاصيل
        ...
        <!-- <td>
            <button class="btn btn-danger btn-sm" onclick="openDeleteModal('{{ $report->id }}')">
                حذف
            </button>
        </td> -->
    </tr>
@endforeach
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-flex align-items-center mb-3">
                    <img id="userImage" src="{{ asset('assets/images/profile.png') }}" alt="User Image" class="rounded-circle" width="50" height="50">
                    <div class="ms-3">
                        <h5 id="userName"></h5>
                        <p id="serviceName"></p>
                    </div>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCart">
    ...
    <div class="offcanvas-footer h-70 p-3 border-top">
      <div class="d-grid">
        <button type="button" class="btn btn-grd btn-grd-primary" data-bs-dismiss="offcanvas">View reports</button>
      </div>
    </div>
  </div>
  <!--end cart-->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" onclick="deleteReport()">Yes, Delete</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function deleteReport() {
        ...
        fetch(`/reports/delete_report/${reportId}`, {
            method: "get",
            headers: {
        ...
        .then(data => {
            if (data.success) {
                ...
                location.reload(); // Reload page to update the report list
            } else {
    ...
    function openDetailsModal(userName, userImage, serviceName, reportText) {
...
//userImage ? userImage : '/path/to/default-image.jpg';
