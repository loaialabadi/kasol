...
<style>
    .cke_notifications_area,.notification,.tox-notification--warning {
...
<body>
  ...
  <main class="main-wrapper">
    <div class="main-content">
        ...
        <div class="ps-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">الاعدادات العامه</li>
            </ol>
          </nav>
        </div>
        <div class="ms-auto">
      ...
      {{--    <div class="col-auto">
          <div class="position-relative">
            <input class="form-control px-5" type="search" placeholder="Search settings">
            <span
        ...
        <div class="col-auto">
          {{--  <div style="justify-content: space-between" class="d-flex align-items-center gap-2 justify-content-lg-end justify-between">
            <a class="btn btn-primary px-4" href="/settings/add_new_setting">
    ...
    @csrf
    <div class="my-4">
        <label for="terms_and_conds">الشروط والاحكام</label>
        <textarea id="terms_and_conds" name="terms_and_conds">{{ $settings->terms_and_conds }}</textarea>
    </div>
    <div class="my-4">
        <label for="about_app">عن التطبيق</label>
        <textarea id="about_app" name="about_app">{{ $settings->about_app }}</textarea>
    </div>
    <div class="my-4">
        <label for="phone">رقم الهاتف</label>
        <input value="{{ $settings->phone }}" class="form-control mt-1" type="text" name="phone" id="phone">
    </div>
    <div class="my-4">
        <label for="email">البريد الالكترونى</label>
        <input value="{{ $settings->email }}" class="form-control mt-1" type="text" name="email" id="email">
    </div>
    <div class="my-4">
        <label for="delivery_price">سعر الشحن للكيلو متر</label>
        <input value="{{ $settings->delivery_price }}" class="form-control mt-1" type="text" name="delivery_price" id="delivery_price">
    </div>
    <div class="my-4">
        <label for="start_order_price">بدايه سعر توصيل الطلب</label>
        <input value="{{ $settings->start_order_price }}" class="form-control mt-1" type="text" name="start_order_price" id="start_order_price">
    </div>
    <div>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCart">
    ...
    <div class="offcanvas-footer h-70 p-3 border-top">
      <div class="d-grid">
        <button type="button" class="btn btn-grd btn-grd-primary" data-bs-dismiss="offcanvas">View settings</button>
      </div>
    </div>
  </div>
  <!--end cart-->
...
<script>
    tinymce.init({
        selector: '#terms_and_conds',
        menubar: false,
        plugins: 'advlist autolink lists link charmap print preview anchor searchreplace visualblocks code fullscreen insertdatetime table paste help wordcount',
...
<script>
    CKEDITOR.replace('terms_and_conds');
</script>

<script src="https://cdn.ckeditor.com/4.20.1/standard/ckeditor.js"></script>
<script>
    CKEDITOR.replace('about_app');
    CKEDITOR.replace('terms_and_conds'); // Optionally add this line for the other field
</script>
</body>
