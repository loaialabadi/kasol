      ...
      <!--breadcrumb-->
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
              <div class="card">
                 <div class="card-body">
                    <form action="{{ route('store_new_service') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                          <div class="mb-4">
                      <h5 class="mb-3">المستخدم</h5>
                      <select class="form-control searchable-dropdown" name="user">
                      ...
                      {{--  <input type="text" name="name" class="form-control" placeholder="write here....">  --}}
                          ...
                          <div class="mb-4">
                      <h5 class="mb-3">الفئه</h5>
                      <select class="form-control searchable-dropdown" name="category_id">
                      ...
                      <input type="text" name="phone" class="form-control" >
                          ...
                          <div class="mb-4">
                      <h5 class="mb-3">البانر</h5>
                      <input type="file" name="banner" class="form-control" >
                   </div>
                          <div class="mb-4">
                      <h5 class="mb-3">اللوجو</h5>
                      <input type="file" name="logo" class="form-control" >
                   </div>
                          <div class="mb-4">
                      <h5 class="mb-3">المنيو</h5>
                      ...
                      {{--  <input type="file" name="menu" class="form-control" placeholder="write here....">  --}}
                   </div>

                   <div class="mb-4">
                    <h5 class="mb-3">الوصف</h5>
                    <textarea name="description" class="form-control" id=""></textarea>
                    {{--  <input type="text" name="description" class="form-control" placeholder="write here....">  --}}
                 </div>
                   <div class="mb-4">
                    <h5 class="mb-3">تاريخ الفتح</h5>
                    {{--  <textarea name="" type class="form-control" id=""></textarea>  --}}
                    <input type="time" name="start_work_date" class="form-control" placeholder="write here....">
                 </div>
                   <div class="mb-4">
                    <h5 class="mb-3">تاريخ الغلق</h5>
                    {{--  <textarea name="" type class="form-control" id=""></textarea>  --}}
                    <input type="time" name="end_work_date" class="form-control" >
                 </div>
                 
                   <div class="mb-4">
                      <h5 class="mb-3">النسبه من الطلبات</h5>
                      <input type="text" name="service_ratio" class="form-control" >
                   </div>
