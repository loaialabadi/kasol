    ...
    <div class="main-content">
      <!--breadcrumb-->
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">إضافه منتج</div>
					<div class="ps-3">
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
              <div class="card">
                 <div class="card-body">
                    <form action="{{ route('store_serv_prod',['id'=>$id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                          <div class="mb-4">
                   ...
                   <div class="mb-4">
                    ...
                    <input type="number" name="price" class="form-control" placeholder="write here....">
                 </div>
