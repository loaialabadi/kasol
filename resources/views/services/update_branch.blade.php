      ...
      <!--breadcrumb-->
        ...
        <div class="row">
          <div class="col-12 col-lg-12">
              <div class="card">
                 <div class="card-body">
                    <form action="{{ route('store_update_branch',['id'=>$id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                          <div class="mb-4">
                      ...
                      <input value="{{$branch->name}}" type="text" name="name" class="form-control" >
                          ...
                          <div class="mb-4">
                      <h5 class="mb-3">اسم المستخدم فى الدخول</h5>
                      <input value="{{$branch->user_name}}" type="text" name="user_name" class="form-control" >
                   </div>
                       <div class="mb-4">
                      ...
                      <input value="{{$branch->address}}" type="text" name="address" class="form-control" >
                   </div>
                          <div class="mb-4">
                      <h5 class="mb-3">رقم الهاتف</h5>
                      <input value="{{$branch->phone}}" type="text" name="phone" class="form-control" >
                   </div>
                   <div class="my-3">
                            <img id="bannerPreview" style="width: 100px" src="{{ asset('storage/' . $branch->image) }}" alt="البانر">
                        </div>
                          <div class="mb-4">
                      <h5 class="mb-3">الصوره</h5>
                      <input type="file" name="image" class="form-control image-input" data-preview-id="bannerPreview">
                   </div>
                   ...
                   <div class="mb-4">
                    ...
                    <input value="{{$branch->start_work_date}}" type="time" name="start_work_date" class="form-control" placeholder="write here....">
                 </div>
                   <div class="mb-4">
                    <h5 class="mb-3">تاريخ الغلق</h5>
                    {{--  <textarea name="" type class="form-control" id=""></textarea>  --}}
                    <input value="{{$branch->end_work_date}}" type="time" name="end_work_date" class="form-control" >
                 </div>
