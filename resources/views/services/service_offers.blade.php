...
@endif
      ...
      <div class="row g-3">
        ...
        <div class="col-auto">
          <div class="d-flex align-items-center gap-2 justify-content-lg-end">
            ...
            <a class="btn btn-primary px-4" href="{{ route('add_new_offer',['id'=>$id]) }}">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <div class="d-flex align-items-center gap-3">
                          ...
                          <div class="product-info">
                            {{ isset($offer->product)?$offer->product->name:'' }}
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <div class="d-flex align-items-center gap-3">
                        <p>{{ $offer->descounted_price }}</p>
                        </div>
                      </td>
                     <td>
    <div class="d-flex align-items-center gap-3">
        <p>{{ $offer->price - ($offer->price * ($offer->descounted_price / 100)) }}</p>
    </div>
</td>
                    ...
                    <td><a class="btn btn-primary" href="{{ route('change_offer_status',['id'=>$offer->id]) }}">تغيير الحاله</a></td>
                      <td>
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="javascript:void(0);" onclick="openDeleteModal({{ $offer->id }})">حذف</a>
                            </li>
                                                        <li><a class="dropdown-item" href="{{ route('update_offer', $offer->id) }}">تحديث</a></li>
                            {{--  <li><a class="dropdown-item" href="{{ route('roles_pemissions', $offer->id) }}">Role Permissions</a></li>  --}}
                            <a class="dropdown-item" href="javascript:void(0);" onclick="openOfferModal({{ $offer }})">
                                عرض التفاصيل
                            </a>
                        </ul>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p><strong>السعر بعد الخصم:</strong> $<span id="offerDiscountedPrice"></span></p>
                </div>
                <div class="modal-footer">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCart">
    ...
    <div class="offcanvas-footer h-70 p-3 border-top">
      <div class="d-grid">
        <button type="button" class="btn btn-grd btn-grd-primary" data-bs-dismiss="offcanvas">View Offers</button>
      </div>
    </div>
  </div>
  <!--end cart-->
...
<script>
    ...
    function openOfferModal(offer) {
        ...
        document.getElementById('offerDiscountedPrice').innerText = offer.final_price;
...
<script>
    ...
    $('#confirmDeleteButton').on('click', function () {
        if (categoryIdToDelete) {
            ...
            window.location.href = "{{ route('delete_offer', '') }}" + '/' + categoryIdToDelete;
        }
    });
