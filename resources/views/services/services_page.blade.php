      ...
      <div class="row g-3">
        <div class="col-auto">
          <div class="position-relative">
            <form action="{{ route('search_services') }}" method="GET" class="d-flex">
        ...
        <div class="col-auto">
          <div class="d-flex align-items-center gap-2 justify-content-lg-end">
            ...
            <a class="btn btn-primary px-4" href="/services/add_new_service">
              ...
              <table class="table align-middle">
                <thead class="table-light">
                  <tr>
                    ...
                    <th>التوصيل</th>
                    <th>الفروع</th>
                    <th>تغيير حاله التوصيل</th>
                    <th>إحصائيات الطلبات</th>
                    <th>النسبه من الطلب</th>
                    <th>الاوامر</th>
                  </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                      <td><img style="width:100px" src="{{ asset('storage/' . $service->logo) }}" alt="service Image"></td>
                    ...
                    <td><a class="btn btn-primary" href="{{ route('change_service_status',['id'=>$service->id]) }}">تغيير الحاله</a></td>
                    <td>
                        <a href="{{route('service_products',['id'=>$service->id])}}" class="btn btn-primary">
                            المنتجات
                        </a>
                    </td>
                    <td><a href="{{ route('service_offers',['id'=>$service->id]) }}" class="btn btn-primary">العروض</a></td>
                    <td>
    @if($service->has_delivery == 1)
        <p>لديه توصيل</p>
    @else
        <p>ليس لديه توصيل</p>
    @endif
...
<td>
    <a class="btn btn-success" href="{{route('service_branch',['id'=>$service->id])}}">
        الفروع
    </a>
</td>
<td>
    <a class="btn btn-primary" href="{{route('update_serv_deliv',['id'=>$service->id])}}">تغيير</a>
</td>
<td>
    <a class="btn btn-warning" href="{{route('web_service_statistics',['id'=>$service->id])}}">إحصائيات الخدمه</a>
</td>
<td>
                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item" href="javascript:void(0);" onclick="openDeleteModal({{ $service->id }})">حذف</a>
                            </li>
                            <li><a class="dropdown-item" href="{{ route('update_service', $service->id) }}">تحديث</a></li>
                            <li><a class="dropdown-item" href="{{ route('show_service', $service->id) }}">عرض</a></li>
                            {{--  <li><a class="dropdown-item" href="{{ route('service_subservices', $service->id) }}">Subservices</a></li>  --}}
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCart">
    ...
    <div class="offcanvas-footer h-70 p-3 border-top">
      <div class="d-grid">
        <button type="button" class="btn btn-grd btn-grd-primary" data-bs-dismiss="offcanvas">View services</button>
      </div>
    </div>
  </div>
  <!--end cart-->
...
<script>
    ...
    // Function to open the modal and set the service ID for deletion
    ...
    $('#confirmDeleteButton').on('click', function () {
        if (serviceIdToDelete) {
            // Redirect to delete route with the service ID
            window.location.href = "{{ route('delete_services', '') }}" + '/' + serviceIdToDelete;
        }
    });
