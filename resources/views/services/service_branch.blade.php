      ...
      <div class="row g-3">
        ...
        <div class="col-auto">
          <div class="d-flex align-items-center gap-2 justify-content-lg-end">
            ...
            <a class="btn btn-primary px-4" href="/services/add_new_branch/{{$id}}">
              ...
              <table class="table align-middle">
                <thead class="table-light">
                  <tr>
                    ...
                    <th>العنوان</th>
                    <th>رقم الهاتف</th>
                    <th>وقت بدايه العمل</th>
                    <th>وقت نهايه العمل</th>
                ...
                <tbody>
                    ...
                    <tr>
                      <td><img style="width:100px" src="{{ asset('storage/' . $service->image) }}" alt="service Image"></td>
                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="{{ route('update_branch', $service->id) }}">تحديث</a></li>
...
<script>
    ...
    $('#confirmDeleteButton').on('click', function () {
        if (serviceIdToDelete) {
            ...
            window.location.href = "{{ route('delete_branch', '') }}" + '/' + serviceIdToDelete;
        }
    });
