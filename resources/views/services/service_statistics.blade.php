        ...
        <div class="col-auto">
          <div class="d-flex align-items-center gap-2 justify-content-lg-end">
            {{--  <button class="btn btn-filter px-4"><i class="bi bi-box-arrow-right me-2"></i>Export</button>  --}}
                    ...
                    <button class="btn btn-primary" data-bs-target="#add" data-bs-toggle="modal"> <i class="fas fa-add"></i>تحويل مال</button>
        ...
        <div class="card-body">
          <div class="product-table">
            <div class="table-responsive white-space-nowrap">
                <div class="row">
                    <div class="col-lg-4 col-md-12 col-sm-12 form-control">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                         <div class="card rounded-4">
                            <div class="card-body">
                        <h4>عدد طلبات الدفع بالفيزا</h4>
                        <p>{{$data->online_count}}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12 col-sm-12">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12">
                         <div class="card rounded-4">
                            <div class="card-body">
                        <h4>قيمه طلبات الدفع فيزا</h4>
                        <p>{{$data->total_online}}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12 col-sm-12">
                         <div class="card rounded-4">
                            <div class="card-body">
                        <h4>القيمه النهائيه</h4>
                        <p>{{$data->service_money}}</p>
                            </div>
                        </div>
                    </div>
                </div>  
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="UserModalLabel">تحويل</h5>
            ...
            <div class="modal-body">
             ...
             <form method="post" action="{{ route('money_trans',['id'=>$id]) }}" enctype="multipart/form-data">
    @csrf
    <div class="container">
        <div class="row my-4">
            <div class="col-md-12 my-2">
                <label>القميه</label>
                <input type="number" class="form-control @error('mon_val') is-invalid @enderror" name="mon_val" value="{{ old('mon_val') }}" placeholder="أدخل القيمه">
                @error('mon_val')
            ...
            <div class="col-md-12 my-2">
                ...
                <select class="form-control" name="type">
                    <option value="get">تم الاخذ من الخدمه</option>
                    <option value="give">تم الاعطاء للخدمه</option>
                </select>
            </div>
