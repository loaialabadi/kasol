...
<img src="{{ asset('storage/' . $admin->image) }}" class="rounded-circle bg-grd-info p-1" width="60" height="60" alt="user">                      <div class="">
                        <p class="mb-0 fw-semibold">Welcome back</p>
                        <h4 class="fw-semibold mb-0 fs-4 mb-0">{{$admin->name}}</h4>
                      </div>
                    </div>
          ...
          <div class="col-lg-12 col-xxl-8 d-flex align-items-stretch">
            <div class="card w-100 rounded-4">
              <div class="card-body">
               <div class="d-flex align-items-start justify-content-between mb-3">
                  <div class="">
                    <h5 class="mb-0">الطلبات الحديثه</h5>
                  </div>
                  <!--<div class="dropdown">-->
                  <!--  <a href="javascript:;" class="dropdown-toggle-nocaret options dropdown-toggle"-->
                  <!--    data-bs-toggle="dropdown">-->
   ...
   <tbody>
    @foreach($recent_orders as $order) <!-- Iterate over each order -->
      <tr>
        <td>
          <div class="d-flex align-items-center gap-3">
             <div class="">
                <!-- Display user image or default image if none exists -->
                <!--<img src="{{ asset('storage/' . ($order->user->image ?? 'default-image.jpg')) }}" class="rounded-circle" width="50" height="50" alt="">-->
             </div>
        ...
        <td>
          ...
          @if($order->status == 'accepted')
            <p class="dash-lable mb-0 bg-success bg-opacity-10 text-success rounded-2">Accepted</p>
          ...
          @else
            <p class="dash-lable mb-0 bg-secondary bg-opacity-10 text-secondary rounded-2">{{ $order->status }}</p>
          @endif
        </td>
        <!--<td>-->
        <!--  <div class="d-flex align-items-center gap-1">-->
        <!--    <p class="mb-0">{{ $order->rating ?? 'No rating' }}</p>-->
